...
class VehicleLeaderDiyKitCarS1(Vehicle):
...
class PlatoonPidDistanceDiyKitCarS1(Platoon):
...
class VehicleLeaderDiyKitCarS2(Vehicle):
    def __init__(self, order, init_speed, init_travel_distance, init_position, init_distance, vehicle_specs):
        Vehicle.__init__(self, order, vehicle_specs)
        self.speed = init_speed
        self.position = init_position
...
class PlatoonPidDistanceDiyKitCarS2(Platoon):
    def __init__(self, num_vehicles):
        Platoon.__init__(self, num_vehicles, rc_car)

    def init_vehicles(self, num_vehicles, vehicle_specs):
        self.vehicles.append(VehicleLeaderRcVehicleS2(order=0, init_speed=60, init_travel_distance=2.17, init_position=0, init_distance=0, vehicle_specs=vehicle_specs))
...
class VehicleLeaderDiyKitCarS3(Vehicle):
    def __init__(self, order, init_speed, init_travel_distance, init_position, init_distance, vehicle_specs):
        Vehicle.__init__(self, order, vehicle_specs)
        self.speed = init_speed
        self.position = init_position
...
class PlatoonPidDistanceDiyKitCarS3(Platoon):
    def __init__(self, num_vehicles):
        Platoon.__init__(self, num_vehicles, rc_car)
