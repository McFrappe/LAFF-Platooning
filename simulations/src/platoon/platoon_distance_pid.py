...
from src.vehicle.vehicle_distance_pid import VehiclePidDistance
...
class PlatoonPidDistanceS2(Platoon):
    ...
    def init_vehicles(self, num_vehicles, vehicle_specs):
        ...
        for i in range(num_vehicles-1):
            self.vehicles.append(VehiclePidDistance(order=i+1, init_speed=60, init_travel_distance=2.17*(-i), init_position=2.17*(-i+1), init_distance=2.17, vehicle_specs=vehicle_specs, period=self.period))
