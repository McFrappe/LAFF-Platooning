...
class PlatoonBidirectionalStateSpaceTruckS1(PlatoonBidirectional):
...
class PlatoonBidirectionalStateSpaceTruckS2(PlatoonBidirectional):
    def __init__(self, num_vehicles):
        PlatoonBidirectional.__init__(self, num_vehicles, truck)
        self.num_vehicles = num_vehicles
...
class PlatoonBidirectionalStateSpaceTruckS3(PlatoonBidirectional):
    def __init__(self, num_vehicles):
        PlatoonBidirectional.__init__(self, num_vehicles, truck)
        self.num_vehicles = num_vehicles
